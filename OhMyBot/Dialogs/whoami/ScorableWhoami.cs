...
#pragma warning disable 1998
    ...
    public class ScorableWhoami : ScorableBase<IActivity, string, double>
    {
        ...
        protected override async Task<string> PrepareAsync(IActivity item, CancellationToken token)
        {
            ...
            return messageText == "whoami" ? "scorable1-triggered" : null; // this value is passed to GetScore/HasScore/PostAsync and can be anything meaningful to the scoring
        }
        ...
        protected override Task PostAsync(IActivity item, string state, CancellationToken token)
        {
            ...
            var dialog = new ScorableWhoamiDialog();
